export default function SignUpModal({ isOpen, onClose, formData, onChange, onSubmit, switchToSignIn }) {
    ...
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-xl shadow-lg w-96 relative">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <input type="email" name="email" placeholder="Email" value={formData.email} onChange={onChange} className="w-full px-4 py-2 border rounded-lg" required />
        ...
        <p className="text-center text-sm mt-4">
          ...
          <button className="text-blue-500 hover:underline" onClick={switchToSignIn}>Sign In</button>
        </p>
